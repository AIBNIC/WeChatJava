...
public class StuInfo {
	...
	public StuInfo(String stu_name, String stu_idcard, String stu_number, String stu_major, String stu_room,
			String end_time, String uproom,String State) {
	...
	public String getUproom() {
		return uproom;
	}

	public void setUproom(String uproom) {
		this.uproom = uproom;
	}
